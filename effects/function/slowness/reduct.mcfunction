execute if score @s effect_slowness_tick matches 1.. store result storage forgecraft:temp effect.slowness.amount double 0.15 run scoreboard players remove @s effect_slowness_tick 1
