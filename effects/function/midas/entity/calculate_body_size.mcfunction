...
execute as @e[type=block_display,tag=midas_converted_entity,tag=body] if score @s forgecraft.id = .target_id const run data modify entity @s transformation.scale[1] set from storage forgecraft:midas temp.height
