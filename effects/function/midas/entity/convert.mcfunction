...
execute at @s anchored eyes positioned ^-0.5 ^ ^-0.5 run summon block_display ~ ~-0.1 ~ {teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.125f,-0.125f,0.25f],scale:[0.8f,0.8f,0.8f]},Tags:["entity_init","midas_converted_entity","head"],block_state:{id:"minecraft:gold_block"}}
execute at @s anchored feet positioned ^-0.5 ^ ^-0.5 run summon block_display ~ ~-0.25 ~ {teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.35f],scale:[1f,1f,0.55f]},Tags:["entity_init","midas_converted_entity","feet"],block_state:{id:"minecraft:gold_block"}}
