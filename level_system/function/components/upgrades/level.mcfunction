...
execute if score @s forgecraft_lvl matches ..25 at @s run function level_system:components/upgrades/level/basic
execute if score @s forgecraft_lvl matches 26.. at @s run function level_system:components/upgrades/level/advanced
