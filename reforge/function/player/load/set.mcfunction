...
$scoreboard players set @s forgecraft_lvl_stat_boost $(stat_boost)
$scoreboard players set @s forgecraft_lvl_xp_boost $(xp_boost)
scoreboard players set .player_loaded const 1