...
scoreboard players operation .player_lvl const = @p[tag=targetplayer] forgecraft_lvl

execute as @e[tag=target_type_item] at @s if score @s forgecraft.id = .self_id const run tag @s add targetforgeitem
execute as @e[tag=target_type_reforge] at @s if score @s forgecraft.id = .self_id const run tag @s add targetforgemodifier
# ----- Special Detections -----
# > 1. Gilded:
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:isgolditem run scoreboard players set .specialtype forgecraft.id 1
...
# > 2. Axe:
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:isaxe run scoreboard players set .specialtype_axe forgecraft.id 1
# > 3. Bow:
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:isbow run scoreboard players set .specialtype forgecraft.id 3
# > 4. Elytra:
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:iselytra run scoreboard players set .specialtype forgecraft.id 4
# > 5. Hoe:
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:ishoe run scoreboard players set .specialtype_hoe forgecraft.id 1
# > 6. Heads:
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:isheads run scoreboard players set .itemtype forgecraft.id 3
...
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:ismelee run scoreboard players set .itemtype forgecraft.id 1
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:isranged run scoreboard players set .itemtype forgecraft.id 2
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:ishelmet run scoreboard players set .itemtype forgecraft.id 3
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:ischestplate run scoreboard players set .itemtype forgecraft.id 4
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:isleggings run scoreboard players set .itemtype forgecraft.id 5
execute as @e[tag=targetforgeitem,sort=nearest,limit=1] at @s run execute if predicate reforge:isboots run scoreboard players set .itemtype forgecraft.id 6
...
execute unless score .itemtype forgecraft.id matches 1.. run scoreboard players set .isnotlisted const 1
...
# Returns if Player Level doesn't match
...
# Normal Reforge
execute as @s if score .item reforgeId matches 0 if score .itemtype forgecraft.id matches 1.. unless score .item_reforge reforgeId matches 39 unless score .item_reforge reforgeId matches 75 unless score .item_reforge reforgeId matches 85 if score .item_reforge reforgeId matches 1.. run return run function reforge:forging/display/getter/forge_item
# Special Reforges
execute as @s if score .item reforgeId matches 0.. if score .itemtype forgecraft.id matches 1.. if score .item_reforge reforgeId matches 85 run return run function reforge:forging/display/getter/forge_item
...
execute as @s if score .itemtype forgecraft.id matches 1.. if score .item_reforge reforgeId matches 39 unless data entity @n[tag=targetforgeitem] item{id:"minecraft:structure_void"} run return run function reforge:forging/display/getter/forge_item
execute as @s if score .item reforgeId matches 0.. if score .itemtype forgecraft.id matches 1.. if score .item_reforge reforgeId matches 75 unless score .is_item_reforge_item const matches 0.. run return run function reforge:forging/display/getter/forge_item
