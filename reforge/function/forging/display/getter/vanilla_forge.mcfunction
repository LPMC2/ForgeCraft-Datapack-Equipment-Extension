...
execute store result entity @n[tag=iteminit,limit=1] Item.components.minecraft:custom_data.global_id int 1 run scoreboard players get .global_itemid forgecraft.id 
