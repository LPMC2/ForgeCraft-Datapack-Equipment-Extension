...
execute as @e[type=item_display,tag=target_forge_display_item] if score @s forgecraft.id = .self_id const run tag @s add temp_target_display_item
...
execute as @e[type=text_display,tag=target_forge_display_text] if score @s forgecraft.id = .self_id const run function reforge:forging/display/set_details with storage minecraft:reforge temp.display
execute as @e[type=interaction,tag=forge_detection] if score @s forgecraft.id = .self_id const run data modify entity @s width set value 0.5
execute as @e[type=interaction,tag=forge_detection] if score @s forgecraft.id = .self_id const run data modify entity @s height set value 0.5
