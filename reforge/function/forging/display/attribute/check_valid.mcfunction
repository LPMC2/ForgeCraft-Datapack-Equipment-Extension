...
execute unless data entity @s Item.components.minecraft:custom_data{typeid:1} unless data entity @s Item.components.minecraft:custom_data{typeid:7} run return fail
