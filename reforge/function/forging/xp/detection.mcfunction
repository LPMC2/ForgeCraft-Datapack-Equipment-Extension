...
execute as @e[tag=targetforgemodifier,sort=nearest,limit=1] at @s run execute if data entity @s item.components.minecraft:custom_data{reforgeid:82b} run function reforge:forging/item_data/enchantment/get_enchant_player_xp
