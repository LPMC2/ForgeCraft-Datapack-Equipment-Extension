...
execute as @e[type=item_display,tag=target_forge_display_item] if score @s forgecraft.id = .temp_anvil_id const if data entity @s data.data.req_xp store result score .target_req_xp const run data get entity @s data.data.req_xp
