$data modify entity @s Item.components.minecraft:item_name set value {"color":"#DEDEDE","italic":false,"text":"⚒ Assassin $(name)"}
#$data modify entity @s Item.components.minecraft:lore set value [{"color":"dark_gray","italic":false,"text":"⚒ Assassin: Invisibility & Speed I Effect after killing an entity"},[{"color":"dark_gray","italic":false,"text":"Type: "},{"bold":true,"color":"white","italic":false,"text":"$(itemtype)"}]]
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Assassin: Invisibility & Speed I Effect after killing an entity"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Assassin $(name)"

data modify entity @s Item.components.minecraft:custom_data.assassin set value 1
data modify entity @s Item.components.minecraft:custom_data.forge_data.abilities append value "assassin"
