...
$data modify entity @s Item.components.minecraft:item_name set value {"color":"#DEDEDE","italic":false,"text":"⚒ Self-Repairing $(name)"}
#$data modify entity @s Item.components.minecraft:lore set value [{"color":"dark_gray","italic":false,"text":"⚒ Self-Repairing: Repair 1 Damage/s when using"},[{"color":"dark_gray","italic":false,"text":"Type: "},{"bold":true,"color":"white","italic":false,"text":"$(itemtype)"}]]
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Self-Repairing: Repair 1 Damage/s when using"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Self-Repairing $(name)"

data modify entity @s Item.components.minecraft:custom_data.self_repairing set value 1
data modify entity @s Item.components.minecraft:custom_data.forge_data.abilities append value "self_repairing"
