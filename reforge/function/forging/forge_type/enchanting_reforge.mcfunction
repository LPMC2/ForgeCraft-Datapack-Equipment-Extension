...
execute if score .itemtype forgecraft.id matches 1..7 run item modify entity @s container.0 reforge:random_enchantment_req
execute if score .itemtype forgecraft.id matches 8 run item modify entity @s container.0 reforge:enchant_utility
