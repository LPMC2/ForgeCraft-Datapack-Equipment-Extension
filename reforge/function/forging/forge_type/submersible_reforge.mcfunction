$data modify entity @s Item.components.minecraft:item_name set value {"color":"#DEDEDE","italic":false,"text":"⚒ Submersible $(name)"}
#$data modify entity @s Item.components.minecraft:lore set value [{"color":"dark_gray","italic":false,"text":"⚒ Submersible: -50% Block Break Speed, +100% Mining Efficiency & +500% Submerged Mining Speed"},[{"color":"dark_gray","italic":false,"text":"Type: "},{"bold":true,"color":"white","italic":false,"text":"$(itemtype)"}]]
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Submersible: -50% Block Break Speed, +100% Mining Efficiency & +500% Submerged Mining Speed"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Submersible $(name)"

#$data modify entity @s Item.components.minecraft:attribute_modifiers.modifiers append value {type:"block_break_speed",amount:-0.5,operation:"add_multiplied_total",id:"$(uuid1)",slot:"$(slot)"}
# Block Break Speed
...
data remove storage minecraft:attribute new.attribute
$data modify storage minecraft:attribute new.attribute set value {type:"minecraft:submerged_mining_speed",operation:"add_multiplied_total",slot:"$(slot)"}
$data modify storage minecraft:attribute new.attribute_id set value $(uuid3)
...
execute unless score .istextureequipment const matches 0 run data modify entity @s Item.components.minecraft:custom_model_data.strings append value "submersible"
