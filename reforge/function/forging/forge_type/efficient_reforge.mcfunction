...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Efficient: also mine 14 adjacent blocks"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Efficient $(name)"

data modify entity @s Item.components.minecraft:custom_data.efficient set value 1
data modify entity @s Item.components.minecraft:custom_data.forge_data.abilities append value "efficient"
data modify entity @s Item.components.minecraft:rarity set value "rare"
data modify entity @s Item.components.minecraft:custom_data.reforgeid set from storage minecraft:reforge forge.forgeid
execute unless score .istextureequipment const matches 0 run data modify entity @s Item.components.minecraft:custom_model_data.strings append value "efficient"
