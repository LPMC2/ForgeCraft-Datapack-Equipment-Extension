$data modify entity @s Item.components.minecraft:item_name set value {"color":"aqua","italic":false,"text":"⚒ Piglin's Fortune $(name)"}
...
data modify entity @s Item.components.minecraft:custom_data.forge_data.abilities append value "piglin_fortune"
...
execute as @s run function reforge:forging/forge_type/attribute/operation/get_type
execute unless score .istextureequipment const matches 0 run data modify entity @s Item.components.minecraft:custom_model_data.strings append value "piglin_fortune"
