$data modify entity @s Item.components.minecraft:item_name set value {"color":"#DEDEDE","italic":false,"text":"⚒ Turbo $(name)"}
#$data modify entity @s Item.components.minecraft:lore set value [{"color":"dark_gray","italic":false,"text":"⚒ Turbo: +200% attack speed, -40% Attack Damage"},[{"color":"dark_gray","italic":false,"text":"Type: "},{"bold":true,"color":"white","italic":false,"text":"$(itemtype)"}]]
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Turbo: +200% attack speed, -40% Attack Damage"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Turbo $(name)"

#$data modify entity @s Item.components.minecraft:attribute_modifiers.modifiers append value {type:"attack_speed",amount:1.5,operation:"add_multiplied_total",id:"$(uuid5)",slot:"$(slot)"}
# Attack Damage
...
#$data modify entity @s Item.components.minecraft:attribute_modifiers.modifiers append value {type:"attack_damage",amount:-0.5,operation:"add_multiplied_total",id:"$(uuid1)",slot:"$(slot)"}
# Attack Speed
data remove storage minecraft:attribute new.attribute
...
execute as @s run function reforge:forging/forge_type/attribute/operation/get_type
execute unless score .istextureequipment const matches 0 run data modify entity @s Item.components.minecraft:custom_model_data.strings append value "turbo"
