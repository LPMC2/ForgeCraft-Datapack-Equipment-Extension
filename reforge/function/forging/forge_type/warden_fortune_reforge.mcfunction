$data modify entity @s Item.components.minecraft:custom_name set value {"color":"aqua","italic":false,"text":"⚒ Warden's Fortune $(name)"}
...
data modify storage minecraft:attribute new.attribute_amount set value 0.25
execute as @s run function reforge:forging/forge_type/attribute/operation/get_type
data modify entity @s Item.components.minecraft:custom_model_data set value {strings:["warden_fortune"]}
