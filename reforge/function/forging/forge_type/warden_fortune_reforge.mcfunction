$data modify entity @s Item.components.minecraft:item_name set value {"color":"aqua","italic":false,"text":"⚒ Warden's Fortune $(name)"}
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Warden's Fortune: 1% to get 1x Random Ancient City Chest Loot"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Warden's Fortune $(name)"

data modify entity @s Item.components.minecraft:custom_data.warden_fortune set value 1
data modify entity @s Item.components.minecraft:custom_data.forge_data.abilities append value "warden_fortune"
...
data modify storage minecraft:attribute new.attribute_amount set value 0.25
execute as @s run function reforge:forging/forge_type/attribute/operation/get_type
execute unless score .istextureequipment const matches 0 run data modify entity @s Item.components.minecraft:custom_model_data.strings append value "warden_fortune"
