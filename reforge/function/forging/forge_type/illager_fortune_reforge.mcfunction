$data modify entity @s Item.components.minecraft:item_name set value {"color":"aqua","italic":false,"text":"⚒ Illager's Fortune $(name)"}
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Illager's Fortune: 25% to get 1x Random Illager Mansion Chest Loot"}
...
data modify entity @s Item.components.minecraft:custom_data.illager_fortune set value 1
data modify entity @s Item.components.minecraft:custom_data.forge_data.abilities append value "illager_fortune"
...
execute as @s run function reforge:forging/forge_type/attribute/operation/get_type
execute unless score .istextureequipment const matches 0 run data modify entity @s Item.components.minecraft:custom_model_data.strings append value "illager_fortune"
