...
execute if score .itemtype forgecraft.id matches 1 run data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Ender: Right Click to fire Eye of Ender at the cost of 1x Ender Eye."}
execute if score .itemtype forgecraft.id matches 2 run data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"Damage calculation: {Arrow Power + (Power Enchantment Level / 2) + 3(Crit Shot)} * 2"}
execute if score .itemtype forgecraft.id matches 2 run data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Ender: Fire Eye of Ender instead. Can Damage Enderman"}
...
execute if score .itemtype forgecraft.id matches 1 run data modify entity @s Item.components.minecraft:custom_data.ender_reforge_melee set value 1
execute if score .itemtype forgecraft.id matches 2 run data modify entity @s Item.components.minecraft:custom_data.ender_reforge set value 1
...
execute if score .itemtype forgecraft.id matches 1 run data modify entity @s Item.components.minecraft:custom_data.right_click_detection set value 1b

execute if score .itemtype forgecraft.id matches 1 run data modify entity @s Item.components.minecraft:use_effects set value {speed_multiplier:1,can_sprint:true}
execute if score .itemtype forgecraft.id matches 1 run data modify entity @s Item.components.consumable set value {consume_seconds:2147483647,animation:"block",sound:"entity.breeze.shoot",has_consume_particles:false}
