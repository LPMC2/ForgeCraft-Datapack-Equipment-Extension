...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Armor-fluxing: Right Click to Heal 8HP using 5 Armor. Regen/5s."}
...
data modify entity @s Item.components.minecraft:custom_data.armorfluxing_melee set value 1
