...
execute if score .attribute_length const matches 1.. run execute as @s run function reforge:forging/forge_type/attribute/offhand/get_attribute_loop with storage minecraft:attribute store
execute if score .attribute_length const matches 1.. as @s run function reforge:forging/forge_type/attribute/offhand/clone_attribute_init