...
#$data modify storage minecraft:attribute new.attribute_amount set from storage minecraft:attribute list.$(index).amount
$execute store result score .attribute_amount const run data get storage minecraft:attribute list.$(index).amount 1000
...
execute as @s run function reforge:forging/forge_type/attribute/double/set_attribute_data with storage minecraft:attribute new
...
#function reforge:forging/forge_type/attribute/double/set_attribute_id with storage minecraft:attribute store
#execute as @s run function reforge:forging/forge_type/attribute/double/set_attribute with storage minecraft:attribute store
...
execute as @s if score .clone_attribute_index const < .clone_attribute_length const run function reforge:forging/forge_type/attribute/double/clone_attribute_loop with storage minecraft:attribute store