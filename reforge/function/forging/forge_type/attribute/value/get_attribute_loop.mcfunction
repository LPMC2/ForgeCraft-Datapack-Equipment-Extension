...
execute as @s if score .attribute_index const < .attribute_length const run function reforge:forging/forge_type/attribute/value/get_attribute_loop with storage minecraft:attribute store