$data modify entity @s Item.components.minecraft:custom_name set value {"color":"#DEDEDE","italic":false,"text":"⚒ Armorized $(name)"}
#$data modify entity @s Item.components.minecraft:lore set value [{"color":"dark_gray","italic":false,"text":"⚒ Armorized: +6 Armor, +5 Armor Toughness, -50% Durability"},[{"color":"dark_gray","italic":false,"text":"Type: "},{"bold":true,"color":"white","italic":false,"text":"$(itemtype)"}]]
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Armorized: +6 Armor, +5 Armor Toughness, -50% Durability"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Armorized $(name)"

#$data modify entity @s Item.components.minecraft:attribute_modifiers.modifiers append value {type:"armor",amount:6,operation:"add_value",id:"$(uuid1)",slot:"$(slot)"}
# Armor
