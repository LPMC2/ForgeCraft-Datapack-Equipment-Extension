$data modify entity @s Item.components.minecraft:item_name set value {"color":"#DEDEDE","italic":false,"text":"⚒ Drilling $(name)"}
#$data modify entity @s Item.components.minecraft:lore set value [{"color":"dark_gray","italic":false,"text":"⚒ Drilling: +100% Block Break Speed, -50% Block Reach"},[{"color":"dark_gray","italic":false,"text":"Type: "},{"bold":true,"color":"white","italic":false,"text":"$(itemtype)"}]]
...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"⚒ Drilling: +100% Block Break Speed, -50% Block Reach"}
...
$data modify entity @s Item.components.minecraft:custom_data.itemname set value "Drilling $(name)"

#$data modify entity @s Item.components.minecraft:attribute_modifiers.modifiers append value {type:"block_break_speed",amount:1.0,operation:"add_multiplied_base",id:"$(uuid1)",slot:"$(slot)"}
# Block Break Speed
...
data remove storage minecraft:attribute new.attribute
$data modify storage minecraft:attribute new.attribute set value {type:"minecraft:block_interaction_range",operation:"add_multiplied_base",slot:"$(slot)"}
...
execute unless score .istextureequipment const matches 0 run data modify entity @s Item.components.minecraft:custom_model_data.strings append value "drilling"
