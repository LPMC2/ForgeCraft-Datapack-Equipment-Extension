...
data modify entity @s Item.components.minecraft:custom_data.custom_lore.forge append value {"color":"dark_gray","italic":false,"text":"Damage calculation: (Arrow Power + Power Enchantment Level) *2(Crit) * 3(In Water)"}
