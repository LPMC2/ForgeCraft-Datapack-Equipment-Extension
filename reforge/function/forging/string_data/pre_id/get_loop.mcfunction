...
execute if data storage minecraft:string temp{char:":"} run return run function reforge:forging/string_data/pre_id/store
execute if score .string_length const > .string_index const run function reforge:forging/string_data/pre_id/get_loop with storage minecraft:string temp