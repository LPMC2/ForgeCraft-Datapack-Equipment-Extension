...
execute store result score .forgeid1 interaction run data get entity @e[type=interaction,tag=find,limit=1] interaction.player[0]
execute store result score .forgeid2 interaction run data get entity @e[type=interaction,tag=find,limit=1] interaction.player[1]
execute store result score .forgeid3 interaction run data get entity @e[type=interaction,tag=find,limit=1] interaction.player[2]
execute store result score .forgeid4 interaction run data get entity @e[type=interaction,tag=find,limit=1] interaction.player[3]
