...
execute if data entity @p[tag=targetplayer] SelectedItem.id run data modify storage reforge forgecraft.id set from entity @p[tag=targetplayer] SelectedItem.id
...
execute unless data entity @p[tag=targetplayer] SelectedItem.id run data modify storage reforge forgecraft.id set value ""
