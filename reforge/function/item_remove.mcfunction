...
execute as @e[tag=target_type_displayname] at @s if score @s forgecraft.id = @n[tag=target_find] forgecraft.id run function reforge:forging/xp/reset_display
execute as @e[tag=target_forge_display_text] at @s if score @s forgecraft.id = @n[tag=target_find] forgecraft.id run function reforge:forging/xp/reset_display
execute as @e[tag=target_forge_display_item] at @s if score @s forgecraft.id = @n[tag=target_find] forgecraft.id run function reforge:forging/display/reset
