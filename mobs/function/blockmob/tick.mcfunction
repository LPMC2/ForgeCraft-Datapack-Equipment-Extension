...
execute as @e[tag=blockmob_text] at @s if score @s forgecraft.id = @e[tag=target_blockmob,limit=1] forgecraft.id run function mobs:blockmob/setname with storage minecraft:mob store
execute as @e[tag=blockmob_text] at @s if score @s forgecraft.id = @e[tag=target_blockmob,limit=1] forgecraft.id run execute at @e[tag=target_blockmob,limit=1] run tp @s ~ ~1 ~
execute as @e[tag=blockmob_display] at @s if score @s forgecraft.id = @e[tag=target_blockmob,limit=1] forgecraft.id run execute at @e[tag=target_blockmob,limit=1] run tp @s ~ ~0.5 ~
