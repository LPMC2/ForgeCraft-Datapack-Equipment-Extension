...
execute as @s if items entity @s armor.* *[minecraft:custom_data~{glasscannon:1}] run tag @s add target_armor
execute as @s if items entity @s armor.* *[minecraft:custom_data~{glasscannon:1}] run schedule function custom_items:armor/glasscannon/update_value 2t append
...
execute as @s if score @s max_shielding_charges matches 1.. run function custom_items:armor/shielding/get_data
execute as @s if items entity @s armor.* *[minecraft:custom_data~{shielding:1}] run function custom_items:armor/shielding/get_data
...
scoreboard players reset @s supervision_count
...
scoreboard players reset @s sneaky_count
