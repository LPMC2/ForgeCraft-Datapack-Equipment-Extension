...
scoreboard players operation .contagion_duration const *= @s contagion_armor_count
...
execute as @n[tag=onHurt_target] run function custom_items:general/effect/apply_pre with storage minecraft:effect store