...
execute if score .distance const matches ..150 positioned ^ ^ ^0.1 rotated ~ ~ if block ~ ~ ~ #minecraft:replaceable run return run function custom_items:weapon/warped/ray_loop
