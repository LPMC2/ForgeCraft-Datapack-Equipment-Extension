...
execute at @s as @e[type=!#entity_hit_matching:non_mob,distance=..2.25] unless score @s forgecraft.id = .id const run function custom_items:health/damage/apply_near_player with storage minecraft:damage temp