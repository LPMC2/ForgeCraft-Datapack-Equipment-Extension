...
execute at @s unless entity @n[type=#entity_hit_matching:targets,tag=!forgecraft_chain_target,distance=..1.5] run return run function custom_items:weapon/chaining/start_damage
...
execute at @s as @n[type=#entity_hit_matching:targets,tag=!forgecraft_chain_target,distance=..1.5] unless data entity @s Owner run function custom_items:weapon/chaining/start_chaining