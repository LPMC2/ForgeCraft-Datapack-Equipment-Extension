execute as @e[tag=!ray_source,type=!#entity_hit_matching:non_mob,dx=0] positioned ~-0.95 ~-0.95 ~-0.95 if entity @s[dx=0] positioned ~0.95 ~0.95 ~0.95 run return run function custom_items:weapon/sorcerer/on_hit
