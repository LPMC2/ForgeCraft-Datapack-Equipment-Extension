execute at @s anchored eyes positioned ^ ^ ^ run summon item_display ~ ~ ~ {billboard:"fixed",interpolation_duration:1,teleport_duration:2,item_display:"head",Tags:["projectile","enderball"],item:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{id:[I;-37626187,-1850455024,-1826930358,1198424797],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTM2ZTZjNTlmZGVkMmE0ZTMzMzZjYzQ3MTMwN2I0YjM5ZmUwMjdjNzJiMmY5MWJmNDMyYWE4Njg1Y2E3ZTUwNyJ9fX0="}]}}}}
